...
import (
	...
	"github.com/A-Victory/Go-Micro/broker/event"
	"github.com/A-Victory/Go-Micro/broker/logs"
...
func (app *Config) HandleSubissions(w http.ResponseWriter, r *http.Request) {
	...
	default:
		app.errorJSON(w, errors.New("unknown action "+reqPayload.Action))
	}
}
...
func (app *Config) LogVIAgGRPC(w http.ResponseWriter, r *http.Request) {
